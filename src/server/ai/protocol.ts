...
Правила:
- НЕ вживай військові звання (полковник, майор, капітан тощо) чи посади перед іменами — НІДЕ в тексті, тільки «Ім'я ПРІЗВИЩЕ».
...
- Доповідач/відповідальний: якщо особа Є у списку учасників — заповни speakerId/responsibleId її id (зіставляй за прізвищем/іменем), а speakerName/responsibleName залиш null. Якщо особи НЕМАЄ у списку — id = null, а ПІБ впиши у speakerName/responsibleName у форматі «Ім'я ПРІЗВИЩЕ» у називному відмінку, БЕЗ звання (напр. «Сергій КОВАЛЕНКО»). Не заповнюй одночасно і id, і name.
        ...
        items: {
          ...
          properties: {
            ...
            speakerName: {
              type: ['string', 'null'],
              description:
                'ПІБ доповідача текстом («Ім’я ПРІЗВИЩЕ», без звання), якщо його НЕМАЄ у списку учасників; інакше null.',
            },
          },
          required: ['title'],
        },
