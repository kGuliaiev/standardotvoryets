  ...
  return (
    <aside className="w-[228px] bg-white border-r border-hairline flex flex-col shrink-0 overflow-hidden">
      ...
      <div className="flex items-center gap-2.5 px-4 py-4 border-b border-hairline">
        ...
        <span className="text-navy font-extrabold text-sm leading-tight">Стандарто-творець</span>
      </div>
              ...
              {section.items.map((item) => {
                ...
                return (
                  <Link
                    ...
                    href={item.href}
                    className={cn(
                      'group flex items-center gap-2.5 px-2 py-2 rounded-[10px] text-sm transition-colors',
                      isActive
            ...
            <div className="space-y-0.5">
              {memberships.map((m) => (
                <Link
                  ...
                  className="group flex items-center gap-2.5 px-2 py-1.5 rounded-[10px] text-xs text-mid hover:bg-pill hover:text-ink transition-colors"
                >
                  <span
